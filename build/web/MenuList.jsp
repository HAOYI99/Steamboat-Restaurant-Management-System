<%-- 
    Document   : MenuList
    Created on : Jul 7, 2021, 10:53:25 PM
    Author     : IM10
--%>
        ...
        <div class="w3-main" style="margin-left:200px">
            ...
            <div class="w3-container">
                ...
                <div class="w3-responsive">
                    <a href="<%=request.getContextPath()%>/newMenuForm" class="w3-margin-right w3-margin-bottom w3-red w3-left w3-padding-large"
                       style="text-decoration: none">New Menu</a>
                        ...
                        <tbody>
                            <c:forEach var="menu" items="${menulist}">
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${menu.menuDesc}" />
                                    </td>
                                    <td>
                                        <c:out value="${menu.menuCategory}" />
                                    </td>
                                    <td>
                                        <c:out value="${menu.menuPrice}" />
                                    </td>
                                    <td>
                                        <img src="data:image/jpg;base64,${menu.menuImage}" width="200" height="180" />
                                    </td>
                                    <td>
                                        <c:out value="${menu.menuAvailable}" />
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/editMenuForm?menuID=<c:out value="${menu.menuID}" />" class="w3-red w3-padding w3-left" style="text-decoration: none">Update</a>
                                        <a href="<%=request.getContextPath()%>/deleteMenu?menuID=<c:out value="${menu.menuID}" />" class="w3-red w3-padding w3-left" style="text-decoration: none">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
